...
urlpatterns = [
    ...
    path('recepcion/lote/<int:lote_id>/', views.recepcion_lote_detail, name='recepcion_lote_detail'),
    path('recepcion/documento/<int:documento_id>/', views.preparacion_documento_detail, name='recepcion_documento_detail'),
